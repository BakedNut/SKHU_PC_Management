...
| 영역 | 항목 |
| --- | --- |
| 기본 환경 | 자주 사용하는 폴더 숨김, 최근 사용 항목 숨김, 탐색기 시작 위치, 파일 확장자 표시, 파일 선택 확인란 비활성화 |
| 바탕화면/로그온 | 내 PC/제어판 아이콘 표시, 부팅 시 암호 입력 생략, 빠른 시작 비활성화 |
| 탐색기/작업표시줄 | Edge 바로가기 삭제, 작업 보기 버튼 숨김, 검색 아이콘 표시, 작업표시줄 아이콘 설정 |
| 시작 메뉴 | Windows 11 전용 시작 메뉴 옵션 |
| 계정/배경 | 암호 만료 비활성화, 기본 배경화면 설정 |
